package br.com.waltervjunior.easymed.service
...
object PreferenceService {
    private fun get(): SharedPreferences = EasymedApplication.context.getSharedPreferences("EASYMED_PREFERENCES", Context.MODE_PRIVATE)
